...
# 0
print(str(id(x))+' '+str(x.val)+' '+str(x.both))
# 2331520241288 2 2331522202632
print(str(id(y))+' '+str(y.val)+' '+str(y.both))
# 2331522202632 3 15037056
print(str(id(z))+' '+str(z.val)+' '+str(z.both))
# 2331522038792 4 212800
print(str(id(a))+' '+str(a.val)+' '+str(a.both))
# 2331522253640 5 2331522038792

print(0 ^ a.both)
print(id(a) ^ z.both) # 2331522202632
print(id(z) ^ y.both) # 2331520241288
